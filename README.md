...
I have currently finished the code to read data from the magnetic encoder register and to move the motors using pwm signals. I am currently working on the PID controller. Physical fabrication of the robot arm is 50% done with the top two joints is complete using PLA components and cycloidal gearboxes.
